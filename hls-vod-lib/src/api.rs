...
pub use crate::segment::cache::{
    cache_stats as segment_cache_stats,
    init_cache as init_segment_cache,
    SegmentCacheConfig,
    SegmentCacheStats,
};
...
impl MediaInfo {
    ...
    pub fn generate_segment(&self, segment_id: &str) -> Result<Vec<u8>> {
        ...
        if segment_id == "v/init.mp4" {
            return segment::generator::generate_video_init_segment(&self.index).map(|b| b.to_vec());
        }
            ...
            .captures(segment_id)
        {
            ...
            return segment::generator::generate_audio_init_segment(&self.index, id_idx, force_aac)
                .map(|b| b.to_vec());
        }
            ...
            .captures(segment_id)
        {
            ...
            let track_idx = self
                ...
                .unwrap_or(0);
            let buf = segment::generator::generate_video_segment(
                &self.index,
                track_idx,
                seq,
            ...
            .captures(segment_id)
        {
            ...
            let buf = segment::generator::generate_audio_segment(
                &self.index,
                id_idx,
                seq,
                &self.index.source_path,
            ...
            .captures(segment_id)
        {
            ...
            let buf = segment::generator::generate_subtitle_segment(
                &self.index,
                id_idx,
                start_seq,
                end_seq,
