...
use crate::ffmpeg::index::read_index_entries;
use crate::state::{SegmentInfo, StreamIndex, SubtitleSampleRef};
...
fn build_segments_from_entries(
    entries: &[crate::ffmpeg::index::IndexEntry],
...
fn map_pts_to_segments(
    ...
    for pts in pts_iter {
        ...
        let rescaled = crate::ffmpeg::utils::rescale_ts(sub_playtime, sub_tb, video_tb);
