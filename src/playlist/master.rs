...
pub fn generate_master_playlist(index: &StreamIndex) -> String {
    ...
    // Get filename to use as URL prefix for relative paths
    let base_name = index
        .source_path
        .file_name()
...
mod tests {
    use super::*;
    use crate::state::{AudioStreamInfo, SubtitleFormat, SubtitleStreamInfo, VideoStreamInfo};
