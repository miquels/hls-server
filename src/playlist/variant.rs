...
pub fn generate_subtitle_playlist(index: &StreamIndex, track_index: usize) -> String {
    ...
    let is_non_empty = |sequence: usize| -> bool {
...
pub fn calculate_target_duration(segments: &[crate::state::SegmentInfo]) -> u32 {
...
mod tests {
    use super::*;
    use crate::state::{AudioStreamInfo, SegmentInfo, StreamIndex, VideoStreamInfo};
